package com.example.a10_118.ui.view.Catatan
...
import com.example.a10_118.ui.viewmodel.Catatan.CatatanPenyediaViewModel
import com.example.a10_118.ui.viewmodel.Catatan.InsertCatatanUiEvent
import com.example.a10_118.ui.viewmodel.Catatan.InsertCatatanViewModel
...
fun FormInputCatatan(
    ...
    Column(
        ...
        // Menampilkan nama tanaman yang diambil berdasarkan idTanaman
        if (insertCatatanUiEvent.idTanaman.isNotEmpty()) {
            Text(text = "Tanaman: ${insertCatatanUiEvent.idTanaman}")
        }
        OutlinedTextField(
